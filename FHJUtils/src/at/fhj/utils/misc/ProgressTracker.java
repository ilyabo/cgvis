...
public class ProgressTracker {
  ...
  //private List taskWeightMultipliers;
  ...
  public void reset() {
    ...
    /*if (taskWeightMultipliers != null) {
      taskWeightMultipliers.clear();
    }*/
    isFinished = false;
    isCancelled = false;
  ...
  public void multiplyTaskWeight(double alpha) {
    /*if (taskWeightMultipliers == null) {
      taskWeightMultipliers = new ArrayList();
    }*/
    taskWeightMultiplier *= alpha;
    //taskWeightMultipliers.add(new Double(alpha));
  }

  /*public void removeLastTaskWeightMultiplier() {
    if (taskWeightMultipliers != null) {
      final int size = taskWeightMultipliers.size();
      if (size > 0) {
        double alpha = ((Double)taskWeightMultipliers.remove(size - 1)).doubleValue();
        taskWeightMultiplier /= alpha;
      }
    }
  }*/
